package lol.arch.punishmenthelper.utils.commands;
...
public abstract class Command {
    ...
    public PunishmentHelper plugin;
    private CommandExecutor executor;
    private CommandArgs assigned;

    public Command() {
        this.plugin = PunishmentHelper.i();
        this.register();
    }
    ...
    public class CommandExecutor extends BukkitCommand {
        ...
        public boolean execute(CommandSender sender, String label, String[] args) {
            ...
            if (!this.getPermission().isEmpty() && !sender.hasPermission(this.getPermission())) {
                sender.sendMessage(Config.ERROR_NO_PERMISSION.toString());
                return false;
            }
